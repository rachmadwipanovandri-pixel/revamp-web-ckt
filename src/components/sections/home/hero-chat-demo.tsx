      ...
      <div className="min-w-0">
        ...
        >
          <div
            ...
            className={cn(
              // Viewport-clamped height: a fixed 600px frame plus the hero
              // chrome pushed the composer past the fold on short laptops.
              "relative isolate mx-auto flex h-[min(560px,72svh)] w-full max-w-[330px] flex-col overflow-hidden bg-gradient-to-br from-slate-700 via-foreground to-slate-950 p-2.5 shadow-2xl ring-1 ring-black/10 rounded-[2.75rem] transition-[width,max-width,height,border-radius,padding] duration-900 ease-[cubic-bezier(0.22,1,0.36,1)] motion-reduce:transition-none will-change-[width,height,border-radius]",
              isPhone
                ? "sm:aspect-auto sm:h-[min(600px,68svh)] sm:w-[300px] sm:max-w-[300px] sm:rounded-[2.75rem] lg:mx-0"
